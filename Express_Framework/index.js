...
import createPost from "./question6CreatePost.js";
import listPost from "./question6Listing.js";
import individualPost from './question6Individual.js';
...
app.post("/contact",question2,question3);
app.post("/",errorPage);
app.post("/create",createPost);
app.post("/post",listPost);
app.post("/individualPost/:id",individualPost);
